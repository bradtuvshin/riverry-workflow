...
const OrderManagement = ({ themeClasses }) => (
  <div className={`${themeClasses.cardBg} ${themeClasses.border} border rounded-lg p-6`}>
    ...
    <p className={themeClasses.textSecondary}>Order management interface coming soon...</p>
  </div>
);

const PayrollManagement = ({ themeClasses }) => (
  <div className={`${themeClasses.cardBg} ${themeClasses.border} border rounded-lg p-6`}>
    <div className="flex items-center justify-between mb-6">
      <h2 className={`text-xl font-semibold ${themeClasses.textPrimary}`}>Payroll Management</h2>
      <button className="btn btn-primary">
        <DollarSign className="w-4 h-4 mr-2" />
        Process Payroll
      </button>
    </div>
    <p className={themeClasses.textSecondary}>Payroll management interface coming soon...</p>
  </div>
);

const Analytics = ({ themeClasses }) => (
  <div className={`${themeClasses.cardBg} ${themeClasses.border} border rounded-lg p-6`}>
    <h2 className={`text-xl font-semibold ${themeClasses.textPrimary} mb-6`}>Analytics & Reports</h2>
    <p className={themeClasses.textSecondary}>Analytics dashboard coming soon...</p>
  </div>
);

const AlertsNotifications = ({ themeClasses }) => (
  <div className={`${themeClasses.cardBg} ${themeClasses.border} border rounded-lg p-6`}>
    <h2 className={`text-xl font-semibold ${themeClasses.textPrimary} mb-6`}>Alerts & Notifications</h2>
    <p className={themeClasses.textSecondary}>Alerts system coming soon...</p>
  </div>
);

const Integrations = ({ themeClasses }) => (
  <div className={`${themeClasses.cardBg} ${themeClasses.border} border rounded-lg p-6`}>
    <h2 className={`text-xl font-semibold ${themeClasses.textPrimary} mb-6`}>Integrations</h2>
    <p className={themeClasses.textSecondary}>Integration management coming soon...</p>
  </div>
);

const SystemSettings = ({ themeClasses }) => (
  <div className={`${themeClasses.cardBg} ${themeClasses.border} border rounded-lg p-6`}>
    <h2 className={`text-xl font-semibold ${themeClasses.textPrimary} mb-6`}>System Settings</h2>
    <p className={themeClasses.textSecondary}>System settings coming soon...</p>
  </div>
);
